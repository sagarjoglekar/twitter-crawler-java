...
//    }
	  ...
	  public TwitterResponse(String min_position, boolean has_more_items, String items_html) {
		  this.min_position = items_html;
		  this.has_more_items = has_more_items;
		  this.items_html = items_html;
	  }
...
//	  System.out.println("ITEMS-HTML : " + items_html);
	  ...
	  return tweets;
		...
		/**
		 * @param min_position the min_position to set
		 */
